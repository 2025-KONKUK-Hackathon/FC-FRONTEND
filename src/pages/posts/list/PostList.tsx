...
const dummyPosts: PostData[] = [
  {
    ...
    content: "다음 주부터 중앙도서관 이용 시간이 변경됩니다. 평일 오전 8시부터 오후 10시까지 운영되며, 주말은 오전 9시부터 오후 6시까지입니다.",
  ...
  },
  {
    id: "2",
    title: "컴퓨터공학부 동아리 모집",
    content: "프로그래밍 동아리에서 새로운 멤버를 모집합니다. 함께 토이 프로젝트를 만들고 기술 스택을 쌓아가실 분들을 기다립니다.",
    categories: [
  ...
  },
  {
    id: "3",
    title: "학식 메뉴 추천해주세요!",
    content: "요즘 학식이 맛있어졌다고 하는데, 어떤 메뉴가 제일 맛있나요? 추천해주시면 내일 당장 먹으러 갈게요 ㅎㅎ",
  ...
  },
  {
    ...
    content: "자료구조와 알고리즘 과목 중간고사 준비 스터디 그룹을 만들려고 합니다. 함께 공부하실 분들 댓글로 연락주세요!",
    categories: [
  ...
  },
  {
    ...
    content: "학교 근처 숨은 맛집들을 정리해서 지도로 만들어봤습니다. 혹시 빠진 곳이 있다면 댓글로 알려주세요!",
  ...
  },
  {
    ...
    content: "기말고사 준비로 밤새 공부할 곳을 찾고 있어요. 학교 근처에 24시간 운영하는 카페나 스터디카페 있나요?",
    categories: [
      { text: "질문", icon: "❓", color: "Yellow" },
  ...
  },
  {
    ...
    content: "다음 달 학교 축제 준비를 위한 봉사자를 모집합니다. 함께 즐거운 축제를 만들어갈 분들의 많은 참여 바랍니다.",
  ...
  },
  {
    id: "8",
    title: "노트북 추천 부탁드려요",
    content: "프로그래밍 수업용으로 사용할 노트북을 찾고 있습니다. 예산은 100만원 정도이고, 개발 환경 구축에 좋은 모델 추천해주세요.",
    categories: [
      { text: "질문", icon: "❓", color: "Yellow" },
  ...
  },
  {
    id: "9",
    title: "교환학생 준비 팁 공유",
    content: "다음 학기 미국 교환학생을 준비하고 있어요. 준비 과정에서 알게 된 유용한 팁들을 공유하니까 참고하세요!",
  ...
  },
  {
    id: "10",
    title: "졸업작품 팀원 구해요",
    content: "웹 개발 졸업작품을 함께 만들 팀원 2명을 구하고 있습니다. React, Node.js 경험이 있으신 분이면 좋겠어요.",
    categories: [
  ...
  },
  {
    id: "11",
    title: "건국대 헬스장 이용 후기",
    content: "학교 헬스장을 한 달째 이용하고 있는데 생각보다 시설이 좋더라고요. 특히 새로 들어온 기구들이 정말 좋습니다.",
  ...
  },
  {
    ...
    content: "목표 점수 900점으로 토익 스터디를 만들려고 해요. 주 3회 모임으로 진행할 예정이니 관심 있으신 분들 연락주세요.",
    categories: [
      { text: "스터디", icon: "📖", color: "Mint" },
  ...
  },
  {
    ...
    content: "요즘 학교 와이파이가 너무 느린 것 같아요. 특히 오후 시간대에는 거의 연결이 안 되는 수준인데, 다른 분들도 그런가요?",
    categories: [
  ...
  },
  {
    id: "14",
    title: "새 학기 교재 나눔해요",
    content: "지난 학기에 사용했던 교재들을 나눔합니다. 경제학원론, 통계학개론, 영어회화 교재 있어요. 필요하신 분 연락주세요!",
    categories: [
  ...
  },
  {
    ...
    content: "학교 정문 앞에 새로 생긴 치킨집 가봤는데 진짜 맛있어요! 양도 많고 가격도 합리적입니다. 추천해요!",
  ...
  },
  {
    id: "16",
    title: "코딩 테스트 준비 스터디",
    content: "취업 준비를 위한 코딩 테스트 스터디원을 모집합니다. 백준, 프로그래머스 문제를 매일 풀고 주 2회 모임으로 진행할 예정입니다.",
    categories: [
      { text: "스터디", icon: "📖", color: "Mint" },
  ...
  },
  {
    ...
    content: "다음 주부터 학교 셔틀버스 시간표가 변경된다고 하네요. 새로운 시간표는 학교 홈페이지에서 확인하실 수 있습니다.",
    categories: [
      { text: "공지사항", icon: "📢", color: "Blue" },
  ...
  },
  {
    id: "18",
    title: "기숙사 룸메이트 구해요",
    content: "다음 학기 기숙사 룸메이트를 구하고 있어요. 깔끔하고 조용한 성격이시면 좋겠습니다. 궁금한 점 있으시면 댓글 남겨주세요!",
    categories: [
  ...
  },
  {
    ...
    content: "조용하고 좌석이 편한 스터디카페를 찾고 있어요. 가격대는 시간당 3000원 이하면 좋겠습니다. 추천 부탁드려요!",
  ...
  },
  {
    ...
    content: "지난주에 다녀온 학과 MT 사진들을 공유해요! 정말 즐거운 시간이었습니다. 내년에도 또 가고 싶네요 ㅎㅎ",
...
const studentCouncilPosts: PostData[] = [
  {
    id: "sc1",
    title: "2024-2학기 학생회비 사용 내역 공개",
    content: "2학기 학생회비 사용 내역을 투명하게 공개합니다. 학생 복지를 위한 다양한 사업에 사용되었으니 확인해보세요.",
  ...
  },
  {
    ...
    content: "겨울방학 동안 진행되는 취업준비, 어학연수, 봉사활동 지원 프로그램을 안내드립니다. 많은 참여 부탁드려요.",
    categories: [
      { text: "학생회", icon: "🏛️", color: "Blue" },
  ...
  },
  {
    ...
    content: "더 나은 학교 급식을 위해 학생들의 의견을 수렴하고 있습니다. 설문조사에 참여해주시면 급식 개선에 반영하겠습니다.",
  ...
  },
  {
    ...
    content: "학내 시설 개선이 필요한 부분이 있다면 언제든 건의해주세요. 학생회에서 적극적으로 학교 측에 전달하겠습니다.",
    categories: [
      { text: "학생회", icon: "🏛️", color: "Blue" },
  ...
  },
  {
    ...
    content: "2025년 신입생 오리엔테이션 진행을 도와주실 재학생 도우미를 모집합니다. 함께 신입생들을 환영해주세요!",
